...
namespace NKristek.Wpf.Converters.Tests
{
    ...
    public class OtherConverterTests
    {
        ...
        public void TestValueConverterChain()
        {
            ...
            CompareConverterResult(ValueNullToInverseBoolConverter.Instance, valueNullToInverseBoolConverterChain, null, typeof(object), null, CultureInfo.CurrentCulture);
            CompareConverterResult(ValueNullToInverseBoolConverter.Instance, valueNullToInverseBoolConverterChain, new object(), typeof(object), null, CultureInfo.CurrentCulture);
        }

        private static void CompareConverterResult(IValueConverter referenceConverter, IValueConverter converterToTest, object value, Type targetType, object parameter, CultureInfo culture)
        {
