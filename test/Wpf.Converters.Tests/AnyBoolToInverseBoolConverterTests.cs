...
{
    public class AnyBoolToInverseBoolConverterTests
    {
        [Theory]
        ...
        {
            var converter = new AnyBoolToInverseBoolConverter();
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        public void ProvideValue_returns_instance()
        {
            ...
            Assert.IsType<AnyBoolToInverseBoolConverter>(providedValue);
        }

        [Fact]
        public void Instance_returns_instance()
        {
            var instance = AnyBoolToInverseBoolConverter.Instance;
            Assert.IsType<AnyBoolToInverseBoolConverter>(instance);
        }
    }
}
