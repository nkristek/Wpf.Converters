...
{
    public class AnyBoolToBoolConverterTests
    {
        [Theory]
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        public void ProvideValue_returns_instance()
        {
            ...
            Assert.IsType<AnyBoolToBoolConverter>(providedValue);
        }

        [Fact]
        public void Instance_returns_instance()
        {
            var instance = AnyBoolToBoolConverter.Instance;
            Assert.IsType<AnyBoolToBoolConverter>(instance);
        }
    }
}
