...
namespace NKristek.Wpf.Converters.Tests
{
    public class AllBoolToVisibilityConverterTests
    {
        ...
        {
            var converter = new AllBoolToVisibilityConverter();
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        public void ProvideValue_returns_instance()
        {
            ...
            Assert.IsType<AllBoolToVisibilityConverter>(providedValue);
        }

        [Fact]
        public void Instance_returns_instance()
        {
            var instance = AllBoolToVisibilityConverter.Instance;
            Assert.IsType<AllBoolToVisibilityConverter>(instance);
        }
    }
}
