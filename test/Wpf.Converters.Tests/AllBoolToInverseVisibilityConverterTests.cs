...
{
    public class AllBoolToInverseVisibilityConverterTests
    {
        [Theory]
        ...
        {
            var converter = new AllBoolToInverseVisibilityConverter();
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        public void ProvideValue_returns_instance()
        {
            ...
            Assert.IsType<AllBoolToInverseVisibilityConverter>(providedValue);
        }

        [Fact]
        public void Instance_returns_instance()
        {
            var instance = AllBoolToInverseVisibilityConverter.Instance;
            Assert.IsType<AllBoolToInverseVisibilityConverter>(instance);
        }
    }
}
